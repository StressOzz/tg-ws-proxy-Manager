> [!WARNING]
> Пакеты Python для архитектуры **mips_24kc / mipsel_24kc** не поддерживаются на некоторых версиях **OpenWRT** !
>
> Перед установкой скрипт проверит возможность установки пакетов на ваше устройство.

---

# Установка
> [!IMPORTANT]
>Для установки необходимо не менее ≈ **20** МБ свободного места в корневом разделе.
>
>После установки **tg-ws-proxy** занимает ≈ **20** МБ.
>
